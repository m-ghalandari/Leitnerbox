...
function App() {
  ...
  useEffect(() => {
    axios
      .get("http://192.168.0.3:3001/api/get") // backend URL
  ...
  const addFlashcard = (newFlashcard) => {
    axios
      .post("http://192.168.0.3:3001/api/insert", {
        id: newFlashcard.id,
  ...
  const deleteFlashcard = (id) => {
    ...
    axios
      .delete(`http://192.168.0.3:3001/api/delete/${id}`)
      .then(() => {
  ...
  const editFlashcard = (updatedCard) => {
    axios
      .put("http://192.168.0.3:3001/api/editCard", {
        id: updatedCard.id,
        box: updatedCard.box,
  ...
  const changeFlashcardsLevels = async (cards) => {
    ...
    axios
      .put("http://192.168.0.3:3001/api/increaseLevels", {
        cards,
      })
      .then(() => {})
      .catch((err) => {
